...
#define WEATHER_LEAVES                  23 // Falling Leaves
#define WEATHER_FIREFLIES               24 // Fireflies
...
#define COORD_EVENT_WEATHER_LEAVES              22
#define COORD_EVENT_WEATHER_FIREFLIES           23
