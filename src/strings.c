...
//names
const u8 gText_SideQuestName_1[] = _("Jeremy's Field Notes");
const u8 gText_SideQuestName_2[] = _("Margaret's Field Study");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Jeremy asked you to catch\na Zigzagoon on Route 101.");
const u8 gText_SideQuestDesc_2[] = _("Margaret asked you to catch\na Wurmple on Route 101.");
...
const u8 gText_SideQuestDoneDesc_1[] = _("You can now sense the\nnatures of wild Pokemon.");
const u8 gText_SideQuestDoneDesc_2[] = _("You can now spot held items\non wild Pokemon.");
